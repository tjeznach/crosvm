...
use devices::irqchip::{aia_aplic_addr, aia_imsic_size, AIA_APLIC_SIZE, AIA_IMSIC_BASE};
...
fn create_cpu_nodes(fdt: &mut FdtWriter, num_cpus: u32, timebase_frequency: u32) -> Result<()> {
    ...
    for cpu_id in 0..num_cpus {
        ...
        // Gross, but the compatible string needs a null in the middle
        fdt.property("compatible", b"riscv,cpu-intc-aia\0riscv,cpu-intc\0")?;
